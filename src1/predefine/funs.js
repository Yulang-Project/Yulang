...
const BUILTIN_FUNCTIONS = [
    ...
    },
    {
        ...
        handler: (generator, args) => {
            ...
            generator.builtins.createMemcpy(h.bitcast({ value: newElementPtr, type: elementPtrType }, 'i8*'), h.bitcast({ value: currentPtr, type: elementPtrType }, 'i8*'), { value: oldAllocSize, type: 'i64' });
            generator.indentLevel--;
...
export function findPredefinedFunction(name) {
