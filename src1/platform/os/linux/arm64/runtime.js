...
export function emitLowLevelRuntime_ARM64(platform, generator) {
    ...
    generator.indentLevel++;
    generator.emit(`call i64 @__syscall6(i64 93, i64 1, i64 0, i64 0, i64 0, i64 0, i64 0)`);
...
export function emitGlobalDefinitions_ARM64(generator) {
