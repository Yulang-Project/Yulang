...
export class IRGenerator implements ExprVisitor<IRValue>, StmtVisitor<void> {
    ...
    visitClassDeclaration(stmt: ClassDeclaration): void {
        ...
        const staticMethodsMap: Map<string, FunctionDeclaration> = new Map();
        ...
        // 6. Emit method definitions (definitions pass)
        if (this.pass === 'definition') {
            stmt.methods.forEach(method => {
                ...
                if (!method.isStatic) {
                    methodScope.define("this", {
                        ...
                        ptr: null as any, // Will be set during function emission from parameters
                        isPointer: true,
