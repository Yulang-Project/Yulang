...
import { TypeAnnotation, BasicTypeAnnotation, ArrayTypeAnnotation, PointerTypeAnnotation, FunctionTypeAnnotation } from '../ast.js';
...
export class TypeParser {
    ...
    parse() {
        ...
        if (this.parser.match(TokenType.STRING, TokenType.CHAR, TokenType.BOOL, TokenType.I32, TokenType.I64, TokenType.F32, TokenType.F64, TokenType.OBJECT)) {
        ...
        if (this.parser.match(TokenType.IDENTIFIER)) {
            ...
            if (this.parser.match(TokenType.DOT)) {
                ...
                nameToken = new Token(TokenType.IDENTIFIER, `${nameToken.lexeme}.${property.lexeme}`, null, nameToken.line, nameToken.column);
            }
